...
train_load_config = {
    ...
    'data_loaders': [
        ...
        SuperviselyLoadInformation(dataset_path=_base_path / 'lpr5_supervisely' / 'part_3'),
...
test_load_config = {
    ...
    'dump': DumpConfig(
        clone_images=True,
        annotations_dump_filename=Path(_base_output_path / f'test/annotations/annotations'),
        images_clone_path=Path(_base_output_path / f'test/images'))
}
