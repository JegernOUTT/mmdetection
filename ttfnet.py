...
albu_center_crop_pad = [
    # dict(type='ShiftScaleRotate', rotate_limit=(-5, 5), scale_limit=(-0.02, 0.1), shift_limit=0.,
    #      border_mode=0, value=[128, 128, 128]),
    dict(type='RandomResizedCrop', height=height, width=width, scale=(1., 1.), interpolation=0),
...
#              score_thr=0.3,
#              max_per_img=32),
#          model_checkpoint_path=Path('./work_dirs/ttfnet/teacher.pth')),
# ]
